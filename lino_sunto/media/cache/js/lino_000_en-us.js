...
// Lino.status_bar = new Ext.ux.StatusBar({defaultText:'Lino version 1.6.13.'});
      ...
      tbar = tbar.concat([
        ...
        { scope:this, 
          ...
          handler: function() { 
            ...
            Ext.apply(p,this.get_base_params());
            this.add_param_values(p,true);
            window.open('/b'+this.ls_url + "?" + Ext.urlEncode(p)) 
          } }
      ]);
...
Lino.main_menu = [ { "menu": { "items": [ { "text": "Vendors", "handler": function() {Lino.products.Vendors.grid.run(null)} }, { "text": "Manufacturers", "handler": function() {Lino.products.Manufacturers.grid.run(null)} }, { "text": "Products", "handler": function() {Lino.products.Products.grid.run(null)} } ] }, "text": "Products" }, { "menu": { "items": [ { "text": "Customers", "handler": function() {Lino.support.Customers.grid.run(null)} } ] }, "text": "Customers" }, { "menu": { "items": [ { "menu": { "items": [ { "text": "Product specifications", "handler": function() {Lino.products.ProductSpecs.grid.run(null)} }, { "text": "Product options", "handler": function() {Lino.products.ProductOptions.grid.run(null)} } ] }, "text": "Products" } ] }, "text": "Explorer" }, { "menu": { "items": [ { "text": "About", "listeners": { "render": Lino.quicktip_renderer("Foo","Show information about this site.") }, "handler": function() {Lino.about.About.show.run(null,{ "record_id": -99998 })} } ] }, "text": "Site" }, { "text": "Home", "handler": function() {Lino.handle_home_button()} } ];
Ext.namespace('Lino.products.Vendors')
Ext.namespace('Lino.products.Manufacturers')
...
// js_render_GridPanel_class products.Vendors
Lino.products.Vendors.GridPanel = Ext.extend(Lino.GridPanel,{
  viewConfig : { "getRowClass": Lino.getRowClass, "emptyText": "No data to display." },
  ls_url : "/products/Vendors",
  ls_bbar_actions : [  ],
  cell_edit : true,
  title : "Vendors",
  gc_name : 0,
...
Lino.products.Vendors.put = function(rp,pk) { 
  var h = function() { 
    Lino.run_row_action(rp,"/products/Vendors","GET",pk,"put",null);
  };
  var panel = Ext.getCmp(rp);
  panel.do_when_clean(true,h);
};
Lino.products.Vendors.post = function(rp,pk) { 
  var h = function() { 
    Lino.run_row_action(rp,"/products/Vendors","GET",pk,"post",null);
  };
  var panel = Ext.getCmp(rp);
  panel.do_when_clean(true,h);
};
Lino.products.Vendors.grid = new Lino.WindowAction({  },function(){
  var p = { "is_main_window": true };
  return new Lino.products.Vendors.GridPanel(p);
});

// js_render_GridPanel_class products.Manufacturers
Lino.products.Manufacturers.GridPanel = Ext.extend(Lino.GridPanel,{
  viewConfig : { "getRowClass": Lino.getRowClass, "emptyText": "No data to display." },
  ls_url : "/products/Manufacturers",
  ls_bbar_actions : [  ],
  cell_edit : true,
  title : "Manufacturers",
  gc_name : 0,
...
Lino.products.Manufacturers.put = function(rp,pk) { 
  var h = function() { 
    Lino.run_row_action(rp,"/products/Manufacturers","GET",pk,"put",null);
  };
  var panel = Ext.getCmp(rp);
  panel.do_when_clean(true,h);
};
Lino.products.Manufacturers.post = function(rp,pk) { 
  var h = function() { 
    Lino.run_row_action(rp,"/products/Manufacturers","GET",pk,"post",null);
  };
  var panel = Ext.getCmp(rp);
  panel.do_when_clean(true,h);
};
Lino.products.Manufacturers.grid = new Lino.WindowAction({  },function(){
  var p = { "is_main_window": true };
  return new Lino.products.Manufacturers.GridPanel(p);
});
...
Lino.products.Products.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  ls_bbar_actions : [ { "itemId": "detail", "menu_item_text": "Detail", "tooltip": "Open a detail window on this record", "panel_btn_handler": Lino.show_detail, "iconCls": "x-tbar-application_form", "overflowText": "Detail", "auto_save": true } ],
  cell_edit : true,
  title : "Products",
  gc_name : 0,
  stripeRows : true,
...
// js_render_GridPanel_class products.ProductSpecs
...
Lino.products.ProductSpecs.put = function(rp,pk) { 
  var h = function() { 
    Lino.run_row_action(rp,"/products/ProductSpecs","GET",pk,"put",null);
  };
  var panel = Ext.getCmp(rp);
  panel.do_when_clean(true,h);
};
Lino.products.ProductSpecs.post = function(rp,pk) { 
  var h = function() { 
    Lino.run_row_action(rp,"/products/ProductSpecs","GET",pk,"post",null);
  };
  var panel = Ext.getCmp(rp);
  panel.do_when_clean(true,h);
};
...
Lino.products.ProductOptions.put = function(rp,pk) { 
  var h = function() { 
    Lino.run_row_action(rp,"/products/ProductOptions","GET",pk,"put",null);
  };
  var panel = Ext.getCmp(rp);
  panel.do_when_clean(true,h);
};
Lino.products.ProductOptions.post = function(rp,pk) { 
  var h = function() { 
    Lino.run_row_action(rp,"/products/ProductOptions","GET",pk,"post",null);
  };
  var panel = Ext.getCmp(rp);
  panel.do_when_clean(true,h);
};
...
Lino.support.Customers.put = function(rp,pk) { 
  var h = function() { 
    Lino.run_row_action(rp,"/support/Customers","GET",pk,"put",null);
  };
  var panel = Ext.getCmp(rp);
  panel.do_when_clean(true,h);
};
Lino.support.Customers.post = function(rp,pk) { 
  var h = function() { 
    Lino.run_row_action(rp,"/support/Customers","GET",pk,"post",null);
  };
  var panel = Ext.getCmp(rp);
  panel.do_when_clean(true,h);
};
Lino.support.Customers.grid = new Lino.WindowAction({  },function(){
  var p = { "is_main_window": true };
  return new Lino.support.Customers.GridPanel(p);
});

// js_render_GridPanel_class support.Support_Items
Lino.support.Support_Items.GridPanel = Ext.extend(Lino.GridPanel,{
  viewConfig : { "getRowClass": Lino.getRowClass, "emptyText": "No data to display." },
  ls_url : "/support/Support_Items",
  ls_bbar_actions : [  ],
  cell_edit : true,
  title : "Customers",
  gc_name : 0,
...
Lino.support.Support_Items.put = function(rp,pk) { 
  var h = function() { 
    Lino.run_row_action(rp,"/support/Support_Items","GET",pk,"put",null);
  };
  var panel = Ext.getCmp(rp);
  panel.do_when_clean(true,h);
};
Lino.support.Support_Items.post = function(rp,pk) { 
  var h = function() { 
    Lino.run_row_action(rp,"/support/Support_Items","GET",pk,"post",null);
  };
  var panel = Ext.getCmp(rp);
  panel.do_when_clean(true,h);
};
Lino.support.Support_Items.grid = new Lino.WindowAction({  },function(){
  var p = { "is_main_window": true };
